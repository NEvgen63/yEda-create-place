...
const credentials = require('../../interfaceApp');
...
describe("Create place", () => {
    it("create group", async () => {
        ...
        await $('#place_group_name').setValue(credentials.partnerName)
        ...
        await $('#place_group_vendorHost').setValue(credentials.host)
        await $('#place_group_clientId').setValue(credentials.clientId)
        await $('#place_group_clientSecret').setValue(credentials.clientSecret)
        ...
        await $('#place_group_menuParserClientId').setValue(credentials.clientId)
        await $('#place_group_menuParserClientSecret').setValue(credentials.clientSecret)
        await $('#place_group_menuParserScope').setValue('read write')
        await $('#place_group_menuParserVendorHost').setValue(credentials.host)
    ...
    it("create brend", async () => {
        ...
        await $('#brand_name').setValue(credentials.partnerName)
    ...
    it("create place", async () => {
        ...
        await $('#name').setValue(credentials.partnerName)
        ...
        await $('.body > span > span > span.select2-search.select2-search--dropdown > input').setValue(credentials.partnerName)
        ...
        await $('#select2-placeGroup-container').click()
        await $('.body > span > span > span.select2-search.select2-search--dropdown > input').setValue(credentials.partnerName)
        await browser.keys('Enter')
    ...
    it("create place", async () => {
        ...
        await $('.//a[@href="/place-delivery-zones/198/list"]').click()
        await $('.//a[@href="/place-delivery-zones/198/add"]').click()
