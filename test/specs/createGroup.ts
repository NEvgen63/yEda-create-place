...
import partnerName from "../../interfaceApp"
...
describe("Create place", () => {
    /*it("create group", async () => {
        ...
        await $('#place_group_name').setValue(partnerName)
    ...
    it("create brend", async () => {
        ...
        await $('#brand_name').setValue(partnerName)
    ...
    it("create place", async () => {
        ...
        await $('#name').setValue(partnerName)
        ...
        await $('.body > span > span > span.select2-search.select2-search--dropdown > input').setValue(partnerName)
